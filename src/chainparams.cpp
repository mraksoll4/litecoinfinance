...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x00000000000000000000000000000000000000000000019a1f546180c6e75b9f");

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x44d27133d1b36776f0d959598fb3909e97534d1e27b68275c51ba793642f2a52");
        ...
        vSeeds.emplace_back("seed.ltfn.info");
        vSeeds.emplace_back("seed1.ltfn.info");
        vSeeds.emplace_back("seed2.ltfn.info");
        vSeeds.emplace_back("seed3.ltfn.info");
		vSeeds.emplace_back("seed4.ltfn.info");
		vSeeds.emplace_back("seed5.ltfn.info");
        ...
        checkpointData = {
            {
                ...
                {1550011, uint256S("0xadab54bcec6e5d9e65b8b9fd8a28984ed814994d20e7cd70ea94653308f82be5")},
                {1857536, uint256S("0x3e92d63cc2e37187eff96d8af45fc712eeefe72df374ae203baff0bfd9a5790b")},
            }
        };
...
public:
    CTestNetParams() {
        ...
        consensus.CSVHeight = 76; // 00000000025e930139bac5c6c31a403776da130831ab85be56578f3fa75369bb
        consensus.SegwitHeight = 76; // 00000000002b980fcd729daaa248fd9316a5200e9b367f4ff2c42453e84201ca
        consensus.MinBIP9WarningHeight = 2092; // segwit activation height + miner confirmation window
        consensus.CPUHeight = 100; // hardfork start block
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        ...
        checkpointData = {
            {
                {0, uint256S("4966625a4b2851d9fdee139e56211a0d88575f59ed816ff5e6a63deb4e3e29a0")},
            }
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.MinBIP9WarningHeight = 0;
        consensus.CPUHeight = 2000; // hardfork start block
